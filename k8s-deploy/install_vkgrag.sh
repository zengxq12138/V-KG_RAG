...
echo "Deploying production VKGRAG (using external databases)..."
...
helm upgrade --install vkgrag $SCRIPT_DIR/vkgrag \
  --namespace $NAMESPACE \
...
echo ""
echo "Waiting for vkgrag pod to be ready..."
kubectl wait --for=condition=ready pod -l app.kubernetes.io/instance=vkgrag --timeout=300s -n rag
echo "vkgrag pod is ready"
echo ""
echo "Running Port-Forward:"
echo "    kubectl --namespace rag port-forward svc/vkgrag 9621:9621"
echo "==========================================="
echo ""
