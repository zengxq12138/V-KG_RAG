...
"""This code is a modified version of vkgrag_openai_demo.py"""
...
class CloudflareWorker:
    ...
    async def query(self, prompt, system_prompt: str = "", **kwargs) -> str:
        # since no caching is used and we don't want to mess with everything vkgrag, pop the kwarg it is
...
def configure_logging():
    ...
    log_file_path = os.path.abspath(
        os.path.join(log_dir, "vkgrag_cloudflare_worker_demo.log")
    )

    print(f"\nVKGRAG compatible demo log file: {log_file_path}\n")
