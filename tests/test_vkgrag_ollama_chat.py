"""
VKGRAG Ollama Compatibility Interface Test Script

This script tests the VKGRAG's Ollama compatibility interface, including:
...
def create_error_test_data(error_type: str) -> Dict[str, Any]:
    ...
    """
    error_data = {
        "empty_messages": {"model": "vkgrag:latest", "messages": [], "stream": True},
        "invalid_role": {
            "model": "vkgrag:latest",
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="VKGRAG Ollama Compatibility Interface Testing",
...
Configuration file (config.json):
  {
    "server": {
      ...
      "model": "vkgrag:latest" # Default model name
    },
    "test_cases": {
      "basic": {
