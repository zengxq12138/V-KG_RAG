...
logger = logging.getLogger("vkgrag")
...
if TYPE_CHECKING:
    from vkgrag.base import BaseKVStorage, BaseVectorStorage, QueryParam
...
class VKGRAGPathFilter(logging.Filter):
    """Filter for vkgrag logger to filter out frequent path access logs"""
...
def setup_logger(
    ...
    Args:
        ...
        add_filter: Whether to add VKGRAGPathFilter to the logger
        log_file_path: Path to the log file. If None and file logging is enabled, defaults to vkgrag.log in LOG_DIR or cwd
...
async def aexport_data(
    ...
    if file_format == "csv":
        ...
        with open(output_path, "w", encoding="utf-8") as mdfile:
            mdfile.write("# VKGRAG Data Export\n\n")
        ...
        with open(output_path, "w", encoding="utf-8") as txtfile:
            txtfile.write("VKGRAG DATA EXPORT\n")
            txtfile.write("=" * 80 + "\n\n")
