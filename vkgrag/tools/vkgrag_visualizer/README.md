# VKGRAG 3D Graph Viewer

An interactive 3D graph visualization tool included in the VKGRAG package for visualizing and analyzing RAG (Retrieval-Augmented Generation) graphs and other graph structures.
...
### Quick Install
```bash
pip install vkgrag[tools]  # Install with visualization tool only
# or
pip install vkgrag[api,tools]  # Install with both API and visualization tools
```
...
1. **Command Not Found**
   ...
   pip install vkgrag[tools]

   # Verify installation
   pip list | grep vkgrag
   ```
...
- GitHub Issues: [VKGRAG Repository](https://github.com/HKUDS/VKGRAG)
- Documentation: [VKGRAG Docs](https://URL-to-docs)

## License

This tool is part of VKGRAG and is distributed under the MIT License. See `LICENSE` for more information.

Note: This visualization tool is an optional component of the VKGRAG package. Install with the [tools] option to access the viewer functionality.
