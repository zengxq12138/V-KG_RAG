...
def download_tiktoken_cache(cache_dir: str = None, models: list = None):
    ...
    # Common models used by VKGRAG and OpenAI
    if models is None:
        models = [
            "gpt-4o-mini",  # Default model for VKGRAG
            "gpt-4o",  # GPT-4 Omni
            "gpt-4",  # GPT-4
...
def main():
    ...
    parser = argparse.ArgumentParser(
        prog="vkgrag-download-cache",
        description="Download cache files for VKGRAG offline deployment",
...
For more information, visit: https://github.com/HKUDS/VKGRAG
        """,
    )
    ...
    parser.add_argument(
        "--version", action="version", version="%(prog)s (VKGRAG cache downloader)"
    )

    args = parser.parse_args()

    print("=" * 70)
    print("VKGRAG Offline Cache Downloader")
    print("=" * 70)
