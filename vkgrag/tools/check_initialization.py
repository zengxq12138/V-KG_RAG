#!/usr/bin/env python3
"""
Diagnostic tool to check VKGRAG initialization status.

This tool helps developers verify that their VKGRAG instance is properly
initialized before use, preventing common initialization errors.

Usage:
    python -m vkgrag.tools.check_initialization
"""
...
from vkgrag.base import StoragesStatus


async def check_vkgrag_setup(rag_instance: VKGRAG, verbose: bool = False) -> bool:
    """
    Check if a VKGRAG instance is properly initialized.

    Args:
        rag_instance: The VKGRAG instance to check
    ...
    print("🔍 Checking VKGRAG initialization status...\n")

    # Check storage initialization status
    if not hasattr(rag_instance, "_storages_status"):
        issues.append("VKGRAG instance missing _storages_status attribute")
    ...
    try:
        from vkgrag.kg.shared_storage import get_namespace_data
    ...
    if issues:
        ...
        print("  from vkgrag.kg.shared_storage import initialize_pipeline_status")
        print("  await initialize_pipeline_status()")
        print(
            "\n📚 Documentation: https://github.com/HKUDS/VKGRAG#important-initialization-requirements"
        )
        ...
        print("✅ VKGRAG is properly initialized and ready to use!")
...
async def demo():
    ...
    from vkgrag.llm.openai import openai_embed, gpt_4o_mini_complete
    from vkgrag.kg.shared_storage import initialize_pipeline_status

    print("=" * 50)
    print("VKGRAG Initialization Diagnostic Tool")
    print("=" * 50)
    ...
    await check_vkgrag_setup(rag, verbose=True)
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Check VKGRAG initialization status")
    parser.add_argument(
    ...
    if args.demo:
        ...
        print("Or import this module and use check_vkgrag_setup() with your instance")
