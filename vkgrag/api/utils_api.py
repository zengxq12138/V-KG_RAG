"""
Utility functions for the VKGRAG API.
"""
...
from vkgrag.api import __api_version__ as api_version
from vkgrag import __version__ as core_version
...
def display_splash_screen(args: argparse.Namespace) -> None:
    """
    Display a colorful splash screen showing VKGRAG server configuration
    ...
    line1_text = f"VKGRAG Server v{core_version}/{api_version}"
    ...
    ASCIIColors.yellow(f"{ollama_server_infos.VKGRAG_MODEL}")
