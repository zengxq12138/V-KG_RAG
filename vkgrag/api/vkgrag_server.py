...
from vkgrag.api.utils_api import (
...
from vkgrag.utils import get_env_value
from vkgrag import VKGRAG, __version__ as core_version
from vkgrag.api import __api_version__
from vkgrag.types import GPTKeywordExtractionFormat
from vkgrag.utils import EmbeddingFunc
from vkgrag.constants import (
...
from vkgrag.api.routers.document_routes import (
    DocumentManager,
    create_document_routes,
)
from vkgrag.api.routers.query_routes import create_query_routes
from vkgrag.api.routers.graph_routes import create_graph_routes
from vkgrag.api.routers.ollama_api import OllamaAPI

from vkgrag.utils import logger, set_verbose_debug
from vkgrag.kg.shared_storage import (
    get_namespace_data,
...
from vkgrag.api.auth import auth_handler
...
class LLMConfigCache:
    ...
    def __init__(self, args):
        ...
        if args.llm_binding in ["openai", "azure_openai"]:
            from vkgrag.llm.binding_options import OpenAILLMOptions
        ...
        if args.llm_binding == "gemini":
            from vkgrag.llm.binding_options import GeminiLLMOptions
        ...
        if args.llm_binding == "ollama":
            try:
                from vkgrag.llm.binding_options import OllamaLLMOptions
        ...
        if args.embedding_binding == "ollama":
            try:
                from vkgrag.llm.binding_options import OllamaEmbeddingOptions
        ...
        if args.embedding_binding == "gemini":
            try:
                from vkgrag.llm.binding_options import GeminiEmbeddingOptions
...
def check_frontend_build():
    ...
    if not index_html.exists():
        ...
        ASCIIColors.cyan("    cd vkgrag_webui")
    ...
    try:
        source_dir = Path(__file__).parent.parent.parent / "vkgrag_webui"
        ...
        # Key configuration files (in vkgrag_webui root directory)
        key_files = [
...
def create_app(args):
    ...
    api_key = os.getenv("VKGRAG_API_KEY") or args.key
    ...
    async def lifespan(app: FastAPI):
        ...
        try:
            ...
            if "VKGRAG_GUNICORN_MODE" not in os.environ:
    ...
    # Initialize FastAPI
    base_description = (
        "Providing API for V-KG RAG core, Web UI and Ollama Model Emulation"
    )
    swagger_description = (
        base_description
    ...
    def create_optimized_openai_llm_func(
        ...
        async def optimized_openai_alike_model_complete(
            ...
            **kwargs,
            ...
            from vkgrag.llm.openai import openai_complete_if_cache
    ...
    def create_optimized_azure_openai_llm_func(
        ...
        async def optimized_azure_openai_model_complete(
            ...
            **kwargs,
            ...
            from vkgrag.llm.azure_openai import azure_openai_complete_if_cache
    ...
    def create_optimized_gemini_llm_func(
        ...
        async def optimized_gemini_model_complete(
            ...
            **kwargs,
            ...
            from vkgrag.llm.gemini import gemini_complete_if_cache
    ...
    def create_llm_model_func(binding: str):
        ...
        try:
            if binding == "lollms":
                from vkgrag.llm.lollms import lollms_model_complete

                return lollms_model_complete
            elif binding == "ollama":
                from vkgrag.llm.ollama import ollama_model_complete
    ...
    def create_optimized_embedding_function(
        ...
        async def optimized_embedding_function(texts, embedding_dim=None):
            try:
                if binding == "lollms":
                    from vkgrag.llm.lollms import lollms_embed

                    return await lollms_embed(
                        texts, embed_model=model, host=host, api_key=api_key
                    )
                elif binding == "ollama":
                    from vkgrag.llm.ollama import ollama_embed
                    ...
                    from vkgrag.llm.azure_openai import azure_openai_embed

                    return await azure_openai_embed(texts, model=model, api_key=api_key)
                elif binding == "aws_bedrock":
                    from vkgrag.llm.bedrock import bedrock_embed

                    return await bedrock_embed(texts, model=model)
                elif binding == "jina":
                    from vkgrag.llm.jina import jina_embed
                    ...
                    from vkgrag.llm.gemini import gemini_embed
                    ...
                    from vkgrag.llm.openai import openai_embed
    ...
    async def bedrock_model_complete(
        ...
        **kwargs,
        ...
        # Lazy import
        from vkgrag.llm.bedrock import bedrock_complete_if_cache
    ...
    if args.rerank_binding != "null":
        from vkgrag.rerank import cohere_rerank, jina_rerank, ali_rerank
    ...
    from vkgrag.api.config import OllamaServerInfos
    ...
    try:
        ...
        logger.error(f"Failed to initialize VKGRAG: {e}")
        raise
...
def configure_logging():
    ...
    for logger_name in ["uvicorn", "uvicorn.access", "uvicorn.error", "vkgrag"]:
