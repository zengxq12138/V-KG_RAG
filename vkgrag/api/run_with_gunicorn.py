#!/usr/bin/env python
"""
Start VKGRAG server with Gunicorn
"""
...
from vkgrag.api.utils_api import display_splash_screen, check_env_file
from vkgrag.api.config import global_args
...
def main():
    ...
    from vkgrag.api.config import initialize_config

    initialize_config()

    # Set Gunicorn mode flag for lifespan cleanup detection
    os.environ["VKGRAG_GUNICORN_MODE"] = "1"
    ...
    print("🚀 Starting VKGRAG with Gunicorn")
    ...
    class GunicornApp(BaseApplication):
        ...
        def load_config(self):
            ...
            from vkgrag.api import gunicorn_config
        ...
        def load(self):
            ...
            from vkgrag.api.vkgrag_server import get_application
    ...
    if workers_count > 1:
        ...
        os.environ["VKGRAG_MAIN_PROCESS"] = "1"
