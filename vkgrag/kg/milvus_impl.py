...
import numpy as np
from vkgrag.utils import logger, compute_mdhash_id
...
class MilvusVectorDBStorage(BaseVectorStorage):
    def _create_schema_for_namespace(self) -> CollectionSchema:
        ...
        if self.namespace.endswith("entities"):
            ...
            description = "VKGRAG entities vector storage"
            ...
            description = "VKGRAG relationships vector storage"
            ...
            description = "VKGRAG chunks vector storage"
            ...
            description = "VKGRAG generic vector storage"
