...
class OllamaServerInfos:
    def __init__(self, name=None, tag=None):
        self._vkgrag_name = name or os.getenv(
            "OLLAMA_EMULATING_MODEL_NAME", DEFAULT_OLLAMA_MODEL_NAME
        )
        self._vkgrag_tag = tag or os.getenv(
            "OLLAMA_EMULATING_MODEL_TAG", DEFAULT_OLLAMA_MODEL_TAG
        )
        self.VKGRAG_SIZE = DEFAULT_OLLAMA_MODEL_SIZE
        self.VKGRAG_CREATED_AT = DEFAULT_OLLAMA_CREATED_AT
        self.VKGRAG_DIGEST = DEFAULT_OLLAMA_DIGEST

    @property
    def VKGRAG_NAME(self):
        return self._vkgrag_name

    @VKGRAG_NAME.setter
    def VKGRAG_NAME(self, value):
        self._vkgrag_name = value

    @property
    def VKGRAG_TAG(self):
        return self._vkgrag_tag

    @VKGRAG_TAG.setter
    def VKGRAG_TAG(self, value):
        self._vkgrag_tag = value

    @property
    def VKGRAG_MODEL(self):
        return f"{self._vkgrag_name}:{self._vkgrag_tag}"
