...
from vkgrag.prompt import PROMPTS
from vkgrag.exceptions import PipelineCancelledException
...
from vkgrag.namespace import NameSpace
from vkgrag.operate import (
...
class VKGRAG:
    ...
    # TODO: Deprecated (VKGRAG will never initialize storage automatically on creation，and finalize should be call before destroying)
    auto_manage_storages_states: bool = field(default=False)
    """If True, vkgrag will automatically calls initialize_storages and finalize_storages at the appropriate times."""
    ...
    def __post_init__(self):
        ...
        logger.debug(f"VKGRAG init with param:\n  {_print_config}\n")
    ...
    def _get_storage_class(self, storage_name: str) -> Callable[..., Any]:
        ...
        if storage_name == "JsonKVStorage":
            from vkgrag.kg.json_kv_impl import JsonKVStorage

            return JsonKVStorage
        elif storage_name == "NanoVectorDBStorage":
            from vkgrag.kg.nano_vector_db_impl import NanoVectorDBStorage

            return NanoVectorDBStorage
        elif storage_name == "NetworkXStorage":
            from vkgrag.kg.networkx_impl import NetworkXStorage

            return NetworkXStorage
        elif storage_name == "JsonDocStatusStorage":
            from vkgrag.kg.json_doc_status_impl import JsonDocStatusStorage
    ...
    async def adelete_by_entity(self, entity_name: str) -> DeletionResult:
        ...
        Returns:
            DeletionResult: An object containing the outcome of the deletion process.
        """
        from vkgrag.utils_graph import adelete_by_entity
    ...
    async def adelete_by_relation(
        ...
        Returns:
            DeletionResult: An object containing the outcome of the deletion process.
        """
        from vkgrag.utils_graph import adelete_by_relation
    ...
    async def get_entity_info(
        ...
        from vkgrag.utils_graph import get_entity_info
    ...
    async def get_relation_info(
        ...
        from vkgrag.utils_graph import get_relation_info
    ...
    async def aedit_entity(
        ...
        """
        from vkgrag.utils_graph import aedit_entity
    ...
    async def aedit_relation(
        ...
        """
        from vkgrag.utils_graph import aedit_relation
    ...
    async def acreate_entity(
        ...
        """
        from vkgrag.utils_graph import acreate_entity
    ...
    async def acreate_relation(
        ...
        """
        from vkgrag.utils_graph import acreate_relation
    ...
    async def amerge_entities(
        ...
        """
        from vkgrag.utils_graph import amerge_entities
    ...
    async def aexport_data(
        ...
        """
        from vkgrag.utils import aexport_data as utils_aexport_data
