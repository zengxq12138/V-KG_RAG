"""
Centralized configuration constants for VKGRAG.

This module defines default values for configuration constants used across
different parts of the VKGRAG system. Centralizing these values ensures
