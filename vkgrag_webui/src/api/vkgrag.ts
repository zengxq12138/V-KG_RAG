...
// Types
export type VKGRAGNodeType = {
  id: string
  labels: string[]
  properties: Record<string, any>
}

export type VKGRAGEdgeType = {
  id: string
  source: string
  target: string
  type: string
...
export type VKGRAGGraphType = {
  nodes: VKGRAGNodeType[]
  edges: VKGRAGEdgeType[]
}

export type VKGRAGStatus = {
  status: 'healthy'
...
export type VKGRAGDocumentsScanProgress = {
  is_scanning: boolean
  current_file: string
...
export const checkHealth = async (): Promise<
  VKGRAGStatus | { status: 'error'; message: string }
> => {
  try {
...
export const getDocumentsScanProgress = async (): Promise<VKGRAGDocumentsScanProgress> => {
